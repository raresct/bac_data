...
def load_data():
  ...
  print county_percents.sort('admitted')
  harta_jud = Image.open('docs/harta_bw.png')
  ...
  for k,v in county_pos.items():
    ...
    ImageDraw.floodfill(harta_jud, (x,y), (int((1-alpha)*255), 0, int(alpha*255)))
    draw.text((x,y), k, (0, 0, 0), font=font)
  harta_jud.save("a_test.png")
